...
function averageWordLength(wordsArr) {
  ...
  for (let i = 0; i < wordsArr.length; i++) {
    ...
    sumArrayStrings += wordsArr[i].length;
  }
  let averageStrings = sumArrayStrings / wordsArr.length

  return averageStrings
}
